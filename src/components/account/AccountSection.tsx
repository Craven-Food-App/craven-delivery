...
export const AccountSection = () => {
  ...
  const handleSignOut = async () => {
    try {
      ...
      // Always redirect customers to the customer login landing page after logout
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="hover:shadow-md transition-shadow">
            <CardHeader>
              ...
              <CardDescription>Get More with $0 delivery</CardDescription>
            </CardHeader>
            <CardContent>
              <Button 
                variant="outline" 
          ...
          <Card className="hover:shadow-md transition-shadow">
            <CardHeader>
              ...
              <CardDescription>View and redeem your credits</CardDescription>
            </CardHeader>
            <CardContent>
              <Button 
                variant="outline" 
          ...
          <Card className="hover:shadow-md transition-shadow">
            <CardHeader>
              ...
              <CardDescription>Share Crave'n and get rewarded</CardDescription>
            </CardHeader>
            <CardContent>
              <Button 
                variant="outline" 
