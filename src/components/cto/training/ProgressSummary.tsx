...
import { TrainingProgressSummary } from '@/types/cto-training';
...
export const ProgressSummary: React.FC<ProgressSummaryProps> = ({ summary }) => {
  ...
  const overallProgress = summary.totalEstimatedMinutes > 0
    ? Math.round((summary.completedEstimatedMinutes / summary.totalEstimatedMinutes) * 100)
    : 0;
