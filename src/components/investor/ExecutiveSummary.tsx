          ...
          <div className="space-y-8">
            <section className="prose max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Crave'n Inc. is a technology-enabled food delivery platform designed to serve underserved secondary markets 
                (Tier-2 and Tier-3 cities) with fair, transparent, and sustainable delivery infrastructure. Unlike incumbent 
                platforms that extract 30%+ commissions from merchants, Crave'n operates on a merchant-first model with 
                industry-leading 15% commission rates.
              </p>
            </section>
            ...
            <section className="prose max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                The U.S. food delivery market exceeds $150 billion annually, with the fastest growth occurring in secondary 
                markets where current platforms fail to provide sustainable economics. These markets represent a significant 
                untapped opportunity for a platform optimized for lower-density operations.
              </p>
            </section>
