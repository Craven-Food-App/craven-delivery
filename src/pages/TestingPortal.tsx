...
import { LiveCourierTesting } from '@/components/testing/LiveCourierTesting';
...
import { ArrowLeft, Users, Car, Store, Zap, Database, Gem, Shield, Flame, CheckCircle, Building2, Package } from 'lucide-react';
...
const TestingPortal: React.FC = () => {
  ...
  const navItems = [
    ...
    { id: 'live-courier', label: 'Live Courier (CX) Testing', icon: Package },
