...
const ManagerPortalLayout: React.FC = () => {
  ...
  const navItems: NavItem[] = useMemo(
    () => [
      ...
      { id: 'reviews', label: 'Performance Reviews', icon: FileCheck, path: '/manager/reviews' },
      { id: 'approvals', label: 'Approvals', icon: CheckSquare, path: '/manager/approvals' },
    ],
    []
  );
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', backgroundColor: '#f9fafb', fontFamily: 'Inter, system-ui, sans-serif' }}>
        ...
        >
          ...
          >
            {isSidebarOpen ? (
              ...
              <div style={{ fontSize: '24px', fontWeight: 800, color: '#ff5f1f', margin: '0 auto' }}>M</div>
            )}
            <button
      ...
      {isMobile && (
        ...
        >
          <span style={{ fontSize: '18px', fontWeight: 800, color: '#ff5f1f' }}>Manager Portal</span>
          <button
      ...
      {isMobile && isMobileMenuOpen && (
        <>
          ...
          >
            ...
            >
              <span style={{ fontSize: '20px', fontWeight: 800, color: '#ff5f1f' }}>Manager Portal</span>
              <button
                onClick={() => setIsMobileMenuOpen(false)}
                style={{
                  background: 'none',
