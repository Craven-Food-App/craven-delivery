...
import { IconFileText, IconHome, IconLogout, IconUser } from '@tabler/icons-react';
import { Outlet, useNavigate } from 'react-router-dom';
import { supabase } from '@/integrations/supabase/client';

export const TemplatesPortalLayout: React.FC = () => {
    ...
    >
      ...
      >
        <Group h="100%" px="md" justify="space-between">
          <Group>
            <Burger opened={opened} onClick={toggle} hiddenFrom="sm" size="sm" color="purple" />
            <IconFileText size={28} stroke={2} style={{ color: '#8b5cf6' }} />
            <div>
