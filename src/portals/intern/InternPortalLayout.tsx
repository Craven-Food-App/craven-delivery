...
const InternPortalLayout: React.FC = () => {
  ...
  const navItems: NavItem[] = useMemo(
    () => [
      { id: 'dashboard', label: 'Dashboard', icon: Home, path: '/intern/dashboard' },
      { id: 'training', label: 'Training & Onboarding', icon: BookOpen, path: '/intern/training' },
      { id: 'work', label: 'Work & Tasks', icon: Briefcase, path: '/intern/work' },
      { id: 'performance', label: 'Performance', icon: TrendingUp, path: '/intern/performance' },
      { id: 'academic', label: 'Academic Credit', icon: GraduationCap, path: '/intern/academic' },
      { id: 'conversion', label: 'Conversion Path', icon: Award, path: '/intern/conversion' },
      { id: 'exit', label: 'Exit & Offboarding', icon: ExitIcon, path: '/intern/exit' },
    ],
    []
  );
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', flexDirection: 'column' }}>
        ...
        <p style={{ color: '#6b7280', marginTop: '8px' }}>
          You do not have permission to access the Intern Portal.
        </p>
      </div>
    );
  }
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', backgroundColor: '#f9fafb', fontFamily: 'Inter, system-ui, sans-serif' }}>
        ...
        >
          ...
          >
            {isSidebarOpen ? (
              ...
              <div style={{ fontSize: '24px', fontWeight: 800, color: '#ff5f1f', margin: '0 auto' }}>I</div>
            )}
            <button
      ...
      {isMobile && (
        ...
        >
          <span style={{ fontSize: '18px', fontWeight: 800, color: '#ff5f1f' }}>Intern Portal</span>
          <button
      ...
      {isMobile && isMobileMenuOpen && (
        <>
          ...
          >
            ...
            >
              <span style={{ fontSize: '20px', fontWeight: 800, color: '#ff5f1f' }}>Intern Portal</span>
              <button
                onClick={() => setIsMobileMenuOpen(false)}
                style={{
                  background: 'none',
