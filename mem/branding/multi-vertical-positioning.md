---
name: Multi-Vertical Brand Positioning
description: Crave'N is multi-vertical (Food, Grocery, Retail, Convenience, CX), not food-delivery-only
type: design
---
...
- CX is the 5th division (not a bolt-on). 15% commission cap applies across all divisions.
- Consumers + businesses request CX through the consumer app. CX merchants get a dedicated tablet app + web portal. Dedicated CX drivers use the CX Driver mobile app; Pro/Ultimate Feeders can also accept CX jobs in the Feeder app.