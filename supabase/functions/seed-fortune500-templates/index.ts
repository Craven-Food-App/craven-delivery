...
const sampleData: Record<string, any> = {
  ...
  par_value: '$0.001',
  shareholders: 'Invero, Inc. (40,600,000 shares - 58%), Founder (10,500,000 shares - 15%), Justin Sweet (4,200,000 shares - 6%), Equity Incentive Pool (14,700,000 shares - 21%)',
  fiscal_year: 'December 31',
  ceo_name: 'Torrance Stroman',
  cfo_name: 'Justin Sweet',
  cxo_name: 'Terri Crawford',
  cto_name: 'Vacant',
  cpo_name: 'Jason Parcell',
  ...
  trust_shares: '40,600,000',
  trust_percentage: '58%',
  founder_shares: '10,500,000',
  founder_percentage: '15%',
