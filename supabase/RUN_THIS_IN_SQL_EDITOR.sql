-- =============================================================================
-- RUN THIS IN SUPABASE DASHBOARD → SQL EDITOR (copy/paste, then Run)
-- Fixes: get_marketplace_restaurants 400 "column reference status is ambiguous"
-- If you get "relation public.restaurants_master does not exist", run
-- RUN_FULL_MARKETPLACE_SETUP.sql first (once), then run this again.
-- =============================================================================
