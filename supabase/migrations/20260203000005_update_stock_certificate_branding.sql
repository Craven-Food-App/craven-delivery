-- ============================================================================
-- UPDATE STOCK CERTIFICATE TEMPLATE WITH BRAND ASSETS
-- Adds logo and watermark image placeholders (logo_url, watermark_url)
-- to the stock_certificate template used for executive certificates.
-- ============================================================================
...
<body>
  <div class="page">
    ...
    <!-- Watermark C logo -->
    <img class="watermark" src="{{watermark_url}}" alt="Crave''n watermark" />

    <!-- Header logo -->
    <div class="header">
      <img class="logo" src="{{logo_url}}" alt="Crave''n Logo" />
    </div>
