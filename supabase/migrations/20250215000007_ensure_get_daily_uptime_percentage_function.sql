...
-- Returns default values (100% uptime) if table doesn't exist or has no data
...
BEGIN
  ...
  -- If no rows returned, return default values (full day = 86400 seconds, 100% uptime)
  IF NOT FOUND THEN
...
-- Note: Function has default parameter, so it can be called with or without arguments
