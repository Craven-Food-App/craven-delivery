-- Repair databases that applied the first version of 20260329000000 (storage.objects.name
-- inside the policy caused 42P17). Idempotent: reapplies function + policy.
