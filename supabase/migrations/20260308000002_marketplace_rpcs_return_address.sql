-- ============================================================================
-- Add address to get_marketplace_restaurants and get_business_nearby so
-- consumer and feeder can show precise addresses (map popups, cards).
-- Must DROP first when changing return type (PostgreSQL does not allow REPLACE).
-- ============================================================================

DROP FUNCTION IF EXISTS public.get_business_nearby(numeric, numeric, numeric, text, text, integer);

-- get_business_nearby: add address to catalog and return
...
-- get_marketplace_restaurants: add address to return (must match 20260307 signature + address)
