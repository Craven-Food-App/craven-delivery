...
BEGIN
  ...
  IF existing_restaurant_id IS NULL THEN
    ...
    VALUES (v_restaurant_id, owner_id, 'Thread & Co.', 'Premium streetwear and urban fashion. Signature branded collections featuring limited edition drops and exclusive collaborations.', '101 Fashion Avenue', 'Toledo', 'OH', '43604', '555-1001', 'apparel1@crave-n.shop', 'apparel', true, 4.8, 342, 'https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=400&h=400&fit=crop', 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=800&h=600&fit=crop', NOW(), NOW())
    ON CONFLICT (id) DO NOTHING;
    ...
    (gen_random_uuid(), v_restaurant_id, 'Branded Sneakers', 'Exclusive collaboration sneakers', 14999, category_shoes_id, 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=400&h=400&fit=crop', true, NOW()),
  ...
  IF existing_restaurant_id IS NULL THEN
    ...
    (gen_random_uuid(), v_restaurant_id, 'Sports Jersey', 'Authentic sports jersey, premium quality', 7999, category_apparel_id, 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Athletic Socks', 'Performance athletic socks, 3-pack', 1999, category_accessories_id, 'https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Gym Bag', 'Durable gym bag with multiple compartments', 4999, category_accessories_id, 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&h=400&fit=crop', true, NOW()),
    ...
    (gen_random_uuid(), v_restaurant_id, 'Athletic Tank', 'Breathable athletic tank top', 3499, category_apparel_id, 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&h=400&fit=crop', true, NOW())
    ON CONFLICT DO NOTHING;
  END IF;
  ...
  IF existing_restaurant_id IS NULL THEN
    ...
    INSERT INTO public.menu_items (id, restaurant_id, name, description, price_cents, category_id, image_url, is_available, created_at) VALUES
    (gen_random_uuid(), v_restaurant_id, 'Vintage Denim Jacket', 'Authentic 90s denim jacket, one-of-a-kind', 8999, category_apparel_id, 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Retro Sunglasses', 'Vintage style sunglasses, classic design', 2999, category_accessories_id, 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Vintage Band Tee', 'Authentic concert tee, rare find', 5999, category_apparel_id, 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Classic Leather Boots', 'Vintage leather boots, restored', 11999, category_shoes_id, 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Retro Backpack', 'Vintage style backpack, unique design', 4999, category_accessories_id, 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Vintage Watch', 'Classic timepiece, restored condition', 7999, category_accessories_id, 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Retro High-Waist Jeans', 'Vintage denim, authentic 80s style', 6999, category_apparel_id, 'https://images.unsplash.com/photo-1542272604-787c3835535d?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Vintage Leather Jacket', 'Classic motorcycle jacket, authentic', 14999, category_apparel_id, 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400&h=400&fit=crop', true, NOW())
    ON CONFLICT DO NOTHING;
  END IF;
  ...
  IF existing_restaurant_id IS NULL THEN
    ...
    INSERT INTO public.restaurants (id, owner_id, name, description, address, city, state, zip_code, phone, email, cuisine_type, is_active, rating, total_reviews, image_url, header_image_url, created_at, updated_at)
    VALUES (v_restaurant_id, owner_id, 'Craven Threads', 'Signature Craven branded clothing line. Exclusive apparel, accessories, and merchandise featuring our iconic designs and premium quality.', '105 Fashion Avenue', 'Toledo', 'OH', '43604', '555-1005', 'apparel5@crave-n.shop', 'apparel', true, 4.9, 523, 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&h=400&fit=crop', 'https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=800&h=600&fit=crop', NOW(), NOW())
    ON CONFLICT (id) DO NOTHING;
    ...
    INSERT INTO public.menu_items (id, restaurant_id, name, description, price_cents, category_id, image_url, is_available, created_at) VALUES
    (gen_random_uuid(), v_restaurant_id, 'Craven Signature Hoodie', 'Official Craven branded hoodie, premium quality', 7999, category_apparel_id, 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Craven Logo Tee', 'Classic Craven logo t-shirt, multiple colors', 3999, category_apparel_id, 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Craven Cap', 'Official Craven snapback cap', 2999, category_accessories_id, 'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Craven Tote Bag', 'Canvas tote bag with Craven branding', 2499, category_accessories_id, 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Craven Crewneck', 'Comfortable crewneck sweater, Craven logo', 5999, category_apparel_id, 'https://images.unsplash.com/photo-1542272604-787c3835535d?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Craven Stickers Pack', 'Set of 10 Craven logo stickers', 999, category_accessories_id, 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Craven Windbreaker', 'Lightweight windbreaker with Craven branding', 6999, category_apparel_id, 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400&h=400&fit=crop', true, NOW()),
    (gen_random_uuid(), v_restaurant_id, 'Craven Water Bottle', 'Insulated water bottle with Craven logo', 3499, category_accessories_id, 'https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=400&h=400&fit=crop', true, NOW())
    ON CONFLICT DO NOTHING;
  END IF;
  ...
  IF existing_restaurant_id IS NULL THEN
    ...
    (gen_random_uuid(), v_restaurant_id, 'Training Shoes', 'Multi-purpose training shoes, excellent grip', 10999, category_shoes_id, 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=400&h=400&fit=crop', true, NOW()),
