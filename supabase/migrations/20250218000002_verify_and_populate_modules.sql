-- Verify and populate test modules if they don't exist
-- This migration ensures modules are created even if the previous one failed
...
BEGIN
  ...
  RAISE NOTICE 'Current module count: %', module_count;
  
  -- If no modules exist, populate them
  IF module_count = 0 THEN
    RAISE NOTICE 'No modules found. Populating test modules...';
    ...
    INSERT INTO public.intern_test_modules (
      name, description, category, competency_tags, level, test_type,
      pass_threshold, reviewer_type, artifact_required, counts_toward_promotion,
      allowed_role_states, is_archived, version, instructions
    ) VALUES (
      ...
      'L1', 'Memo', 70, 'Manager', false, false,
      ARRAY['INTERN_ACTIVE'],
      false, 1,
    ...
    -- MODULE 3 — Platform Systems Audit
    INSERT INTO public.intern_test_modules (
      name, description, category, competency_tags, level, test_type,
      time_limit_minutes, pass_threshold, reviewer_type, artifact_required,
      counts_toward_promotion, allowed_role_states, is_archived, version, instructions
    ) VALUES (
      ...
      'L3', 'Artifact', 120, 85, 'Executive', true,
      true, ARRAY['INTERN_ACTIVE', 'ACTING_EXECUTIVE'],
      false, 1,
    ...
    -- MODULE 4 — Internal Tool / Automation Build
    INSERT INTO public.intern_test_modules (
      name, description, category, competency_tags, level, test_type,
      time_limit_minutes, pass_threshold, reviewer_type, artifact_required,
      counts_toward_promotion, allowed_role_states, is_archived, version, instructions
      ...
      'L3', 'Build', 4320, 70, 'Executive', true,
      true, ARRAY['INTERN_ACTIVE', 'ACTING_EXECUTIVE'],
      false, 1,
    ...
    -- MODULE 5 — Executive Decision Memo (Technology)
    INSERT INTO public.intern_test_modules (
      name, description, category, competency_tags, level, test_type,
      pass_threshold, reviewer_type, artifact_required, counts_toward_promotion,
      allowed_role_states, is_archived, version, instructions
      ...
      'L3', 'Memo', 80, 'Executive', false, true,
    ...
    INSERT INTO public.intern_test_modules (
      ...
      'L3', 'Artifact', 85, 'Executive', true, true,
      ARRAY['INTERN_ACTIVE', 'ACTING_EXECUTIVE'],
      false, 1,
    ...
    -- MODULE 7 — Process Bottleneck & Risk Analysis
    INSERT INTO public.intern_test_modules (
      name, description, category, competency_tags, level, test_type,
      pass_threshold, reviewer_type, artifact_required, counts_toward_promotion,
      allowed_role_states, is_archived, version, instructions
      ...
      'L2', 'Scenario', 80, 'Manager', false, true,
      ARRAY['INTERN_ACTIVE', 'ACTING_EXECUTIVE'],
      false, 1,
    ...
    -- MODULE 8 — Executive Readiness Brief
    INSERT INTO public.intern_test_modules (
      name, description, category, competency_tags, level, test_type,
      pass_threshold, reviewer_type, artifact_required, counts_toward_promotion,
      allowed_role_states, is_archived, version, instructions
    ...
    -- MODULE 9 — Driver Onboarding Workflow Mapping
    INSERT INTO public.intern_test_modules (
      name, description, category, competency_tags, level, test_type,
      pass_threshold, reviewer_type, artifact_required, counts_toward_promotion,
      allowed_role_states, is_archived, version, instructions
      ...
      'L2', 'Artifact', 80, 'Manager', true, true,
      ARRAY['INTERN_ACTIVE', 'ACTING_EXECUTIVE'],
      false, 1,
    ...
    -- MODULE 10 — Surge Operations Scenario
    INSERT INTO public.intern_test_modules (
      name, description, category, competency_tags, level, test_type,
      pass_threshold, reviewer_type, artifact_required, counts_toward_promotion,
      allowed_role_states, is_archived, version, instructions
    ...
    -- MODULE 11 — Safety & Compliance Knowledge Test
    INSERT INTO public.intern_test_modules (
      name, description, category, competency_tags, level, test_type,
      pass_threshold, reviewer_type, artifact_required, counts_toward_promotion,
      allowed_role_states, is_archived, version, instructions
    ...
    -- MODULE 12 — Internship Learning Objectives & Initial Reflection
    INSERT INTO public.intern_test_modules (
      name, description, category, competency_tags, level, test_type,
      pass_threshold, reviewer_type, artifact_required, counts_toward_promotion,
      allowed_role_states, retake_limit, is_archived, version, instructions
    ) VALUES (
    ...
    -- MODULE 13 — Final Internship Summary & Self-Assessment
    INSERT INTO public.intern_test_modules (
      name, description, category, competency_tags, level, test_type,
      pass_threshold, reviewer_type, artifact_required, counts_toward_promotion,
      allowed_role_states, is_archived, version, instructions
      ...
      'L2', 'Memo', 70, 'Manager', false, false,
      ARRAY['INTERN_ACTIVE', 'ACTING_EXECUTIVE'],
      false, 1,
    ...
    RAISE NOTICE 'Modules populated. New count: %', module_count;
  ELSE
    RAISE NOTICE 'Modules already exist. Skipping population.';
  END IF;
END $$;
