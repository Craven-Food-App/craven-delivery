...
-- RLS policies (all operations through service role for admin routes)
ALTER TABLE public.invites ENABLE ROW LEVEL SECURITY;

-- Policy: No public access (all access through service role)
CREATE POLICY "invites_no_public_access" ON public.invites
  FOR ALL
  USING (false);
