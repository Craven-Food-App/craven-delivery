import{a2 as m}from"./index-CLcR6DS_.js";const f=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),_=(e,l)=>{const t=Object.entries(l).filter(([,a])=>a!=null&&a!=="").map(([a,i])=>`
        <tr>
